...
//	    panel.setLayout(new GridLayout());
	    ...
	    for(int i = 0; i<a.size();i++)
	    {
	    	...
	    	btnNewButton_1.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(0, 0, 255), new Color(255, 0, 0), new Color(0, 255, 0), new Color(34, 139, 34)));
	    	panel.add(btnNewButton_1);
	    	
	    	JLabel btnNewButton_2 = new JLabel(""+a2.get(i));
	    	btnNewButton_2.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(0, 0, 255), new Color(255, 0, 0), new Color(0, 255, 0), new Color(34, 139, 34)));
    	...
    	lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\Dell\\Downloads\\AJP PR IMG\\WhatsApp_Image_2022-11-26_at_1-removebg-preview.png"));
